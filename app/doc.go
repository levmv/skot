...
// Skot's tools, sessions, settings, model selection, credentials, theme, and
// filesystem scope. A terminal, graphical, or service frontend can drive
// Application without reconstructing those product decisions.
//
